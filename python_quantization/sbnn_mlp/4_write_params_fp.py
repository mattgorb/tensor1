...
def main():
    ...
    for param_tensor in model.state_dict():
        print(param_tensor, "\t", model.state_dict()[param_tensor].size(), "\t", model.state_dict()[param_tensor].cpu().detach().numpy().dtype)
        model_np[param_tensor]=model.state_dict()[param_tensor].cpu().detach().numpy()
        print(model_np[param_tensor])
